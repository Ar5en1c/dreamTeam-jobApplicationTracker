...
describe('ApplicationCard', () => {
  ...
  it('displays status badge', () => {
    ...
    const statusElement = screen.getByText(mockApplication.status, { exact: false });
  ...
  it('displays salary and work arrangement badges', () => {
    ...
    expect(screen.getByText(mockApplication.job.workArrangement)).toBeInTheDocument();
  });
  ...
  it('displays AI match score', () => {
    ...
    if (mockApplication.aiInsights?.matchScore) {
      expect(screen.getByText(`${mockApplication.aiInsights.matchScore}%`)).toBeInTheDocument();
    }
  });
  ...
  it('shows recent activity when available', () => {
    ...
    render(<ApplicationCard application={applicationWithActivity} {...mockHandlers} />);
  ...
  it('handles missing optional data gracefully', () => {
    ...
    expect(screen.getByText(minimalApplication.job.company)).toBeInTheDocument();
  });
});